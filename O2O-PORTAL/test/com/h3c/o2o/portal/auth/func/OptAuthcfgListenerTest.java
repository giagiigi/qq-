 ...
 * @author dkf5133
 */
public class OptAuthcfgListenerTest {
    private Log log = LogFactory.getLog(OptAuthcfgListenerTest.class);

    OptAuthcfgListener listener = null;
    ...
    public void setUp() throws Exception {
        ...
        listener = (OptAuthcfgListener) ServerContext
            .getRootAppContext().getBean("o2oportalOptAuthcfgListener");
    ...
    public void testEcho() throws IOException {
        ...
        MqResponse strResultDel = (MqResponse) rabbitTemplate.convertSendAndReceive(
            UamConstant.AUTHCFG_OPT_EXCHANGE, UamConstant.AUTHCFG_OPT_EXCHANGE_KEY, request);
