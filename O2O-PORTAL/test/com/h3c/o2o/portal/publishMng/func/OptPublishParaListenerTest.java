...
public class OptPublishParaListenerTest {

	private Log log = LogFactory.getLog(getClass());

	private RabbitTemplate rabbitTemplate;

	OptPublishParaListener listener = null;

	@Before
    public void setUp() throws Exception {
        System.out.println("setUp()...");
        listener = (OptPublishParaListener) ServerContext
            .getRootAppContext().getBean("o2oportalOptPublishParaListener");
    ...
    public void testEcho() throws IOException {
        ...
        MqResponse strResultDel = (MqResponse) rabbitTemplate.convertSendAndReceive(
            UamConstant.PUBLISH_MNG_OPT_EXCHANGE, UamConstant.PUBLISH_PARA_OPT_EXCHANGE_KEY, request);
