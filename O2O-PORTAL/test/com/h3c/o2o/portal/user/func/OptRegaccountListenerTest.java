 ...
 * @author dkf5133
 */
public class OptRegaccountListenerTest {

    private Log log = LogFactory.getLog(OptAuthcfgListenerTest.class);

    OptRegaccountListener listener = null;
    ...
    public void setUp() throws Exception {
        ...
        listener = (OptRegaccountListener) ServerContext
            .getRootAppContext().getBean("o2oportalOptRegaccountListener");
    ...
    public void testEcho() throws IOException {
        ...
        MqResponse strResultDel = (MqResponse) rabbitTemplate.convertSendAndReceive(
            UamConstant.REGACCOUNT_OPT_EXCHANGE,
            UamConstant.REGACCOUNT_OPT_EXCHANGE_KEY, request);
