...
<head>
  <link href="../resources/font-awesome/css/font-awesome.min.css" type="text/css" rel="stylesheet" ></link>
    ...
    <link  href="../resources/jqueryui-bootstrap/bootstrap.min.css" type="text/css" rel="stylesheet" ></link>
    ...
    <script type="text/javascript"  src="../../js/adCount.js"></script>
...
<jsp:include page="/i18n.jsp"></jsp:include>
</html>
