...
(function() {
	...
	var URL = "http://localhost:8080/o2o/assets/resources/";
	...
	window.UEDITOR_CONFIG = {
		...
		toolbars : [ [ "undo", "redo", "insertunorderedlist",
				"insertorderedlist", "selectall", "cleardoc", "preview",
				"emotion", "horizontal", "bold", "italic", "underline",
				"forecolor", "backcolor", "fontfamily", "justifyleft",
	...
	// 如果自定义，最好给p标签如下的行高，要不输入中文时，会有跳动感
	 ,initialStyle:'p{line-height:0.5em}'//编辑器层级的基数,可以用来改变字体等
